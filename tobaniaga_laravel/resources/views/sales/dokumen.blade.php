...
<div class="max-w-xl mx-auto py-10 px-4">
    ...
    <div class="text-center mb-8">
        ...
        <p class="text-sm text-ink/50 mt-1">Diperlukan untuk verifikasi akun penjual UMKM kamu.</p>
    </div>
    ...
    <form action="{{ route('sales.dokumen.store') }}" method="POST" enctype="multipart/form-data"
