    ...
    <header class="relative z-20">
        <nav class="max-w-7xl mx-auto px-6 lg:px-10 flex items-center justify-between py-6">
            ...
            <div class="hidden md:flex items-center gap-9 font-medium text-sm text-lake-900/80">
                ...
                <a href="{{ route('produk.index') }}" class="hover:text-ulos-maroon transition-colors focus-ring rounded">Produk</a>
            </div>
                ...
                @auth
                    <div class="relative" x-data="{ open: false }">
                        ...
                        <div x-show="open"
                            ...
                            @role('customer')
                            <a href="#" {{-- ganti dengan route keranjang nanti --}}
                               class="flex items-center justify-between px-4 py-2.5 text-sm text-ink/80 hover:bg-lake-900/5 transition-colors">
                                <span>Keranjang</span>
                            ...
                            <a href="#" {{-- ganti dengan route riwayat pesanan nanti --}}
                               class="block px-4 py-2.5 text-sm text-ink/80 hover:bg-lake-900/5 transition-colors">
                                Riwayat Pesanan
                            </a>
